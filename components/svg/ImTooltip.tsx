const ImTooltip = () => {
  return (
    <div className="title">
      ...
      <svg className="popup-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 130" height="100" width="300">
        <path
      ...
      <svg className="popup-outline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 130" height="100" width="300">
      ...
      <div className="popup-text">
        <div className="grid" style={{ justifyItems: 'end' }}>
          <span className="primary-font-normal">احجز رحلتك الآن</span>
          <span className="english-font">+962 99 08765</span>
        </div>
      </div>
    </div>
  )
