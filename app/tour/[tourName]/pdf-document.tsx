...
export const generate = async (tour: Tour) => {
  ...
  const convertToBase64 = async () => {
    return new Promise((resolve, reject) => {
      ...
      fetch('https://mundo-tours.s3.eu-central-1.amazonaws.com/assets/mundo-logo.png', {
  ...
  const createLogo = async (): Promise<Paragraph> => {
    try {
      ...
      return new Paragraph({
        ...
        children: [
          new ImageRun({
            data: Uint8Array.from(atob(result.replace('data:image/png;base64,', '')), (c) => c.charCodeAt(0)),
            transformation: {
              width: 200,
              height: 100,
            },
